<nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="user-profile">
          <div class="user-image">
            <img src="<?php if(!isset($_SESSION['user_image'])){
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">List Your Food Detail</span>
          ...
          <li class="nav-item">
            <a class="nav-link" href="template/pages/icons/feather-icons.html">
          ...
          <li class="nav-item">
            <a class="nav-link" href="template/docs/documentation.html">
